...
The project uses an LLM with tool calling to allow the assistant to perform actions such as recording a visitor's email address. It also supports switching between multiple LLM providers/models through the UI.
